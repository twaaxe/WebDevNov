...
// Expected output
/*
Fullname; Dickie Stoltz
Email: dstoltzj@phpbb.com
*/


/*for (var i=0 ; i<data.length; i++){
    console.log("full name ; ", data[i].first_name," - ", data[i].last_name);
...
//     console.log("full name : ",item.first_name, " - ",item.first_name) ;
//     console.log(item.email,"\n");
// })

data.forEach(function(index){
    console.log(`full name : ${index.first_name} - index.last_name \n ${index.email}`)
})